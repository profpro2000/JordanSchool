...
namespace Domain.Migrations
{
    ...
    [Migration("20190611083342_schoolv3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Fin.FinItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Domain.Model.Fin.FinItem", b =>
                {
                    b.HasOne("Domain.Model.AddLookups.LkpSchool", "LkpSchool")
                        .WithMany("SchoolFinItems")
                        .HasForeignKey("SchoolId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.AddLookups.LkpSection", "LkpSectoin")
                        .WithMany("SectionFinItems")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.Lookups.LkpLookup", "FinItemTypeLookup")
                        .WithMany("FinItemTypeMasters")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.Lookups.LkpLookup", "VisibleToLookup")
                        .WithMany("VisibleToMasters")
