...
namespace Domain.Migrations
{
    ...
    [Migration("20190608141756_StudMasterV1")]
    partial class StudMasterV1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Stud.StudMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("Stud_Master");
                });

            modelBuilder.Entity("Domain.Model.Stud.StudParent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Domain.Model.Stud.StudMaster", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Stud.StudParent", "StudParent")
                        .WithMany("StudMasters")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.AddLookups.LkpSchool", "LkpSchool")
                        .WithMany("SchoolStudMasters")
                        .HasForeignKey("SchoolId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.AddLookups.LkpClass", "LkpClass")
                        .WithMany("ClassStudMasters")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Model.AddLookups.LkpSection", "LkpSection")
                        .WithMany("SectionStudMasters")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Restrict);
